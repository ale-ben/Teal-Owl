...
export module Utils {
	function saveAsPDF(docFile : GoogleAppsScript.Drive.File, fileName : string) {
		...
		var folder: GoogleAppsScript.Drive.Folder = fileParents.next();
	...
	export function applyExportPDF(document : GoogleAppsScript.Document.Document) {
